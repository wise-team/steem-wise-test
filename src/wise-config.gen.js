...
export const data = {
  ...
  "get_block": true,
    ...
    "docker": {
      ...
      "labels": {
        "domain": "vote.wise",
        "defaultLabels": [ () => "maintainer=\"The Wise Team (https://wise-team.io/) <contact@wiseteam.io>\"", () => "vote.wise.wise-version=\"3.1.1\"", () => "vote.wise.license=\"MIT\"", () => "vote.wise.repository=\"steem-wise-test\"" ],
      },
    ...
    "vault": {
      "servers": {
        ...
        "staging": {
          "url": "https://vault.staging.wise.vote:8200",
        },
      },
  ...
  "policies": [ "admin" ],
    ...
    "sql": {
      "url": {
        ...
        "staging": "https://sql.staging.wise.vote/",
      },
      "port": 8094,
      "protocol": {
        "version": "1.0",
    ...
    "manual": {
      "url": {
        ...
        "staging": "https://docs.staging.wise.vote/introduction",
      },
      "port": 8096,
      "docker": {
        "services": {
    ...
    "votingPage": {
      ...
      "url": {
        ...
        "staging": "https://staging.wise.vote/voting-page/",
      },
      "docker": {
        "services": {
          "frontend": {
    ...
    "hub": {
      "url": {
        ...
        "staging": "https://staging.wise.vote/",
      },
      "port": 8095,
      "visual": {
        "read": {
      ...
      "healthcheck": {
        ...
        "hostedLogs": {
          "url": {
            ...
            "staging": "https://test.staging.wise.vote/",
          },
          "port": 8097,
        },
        "docker": {
